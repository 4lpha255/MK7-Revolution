...
namespace base
{
    void entries::kart::future_fly_menu(CTRPluginFramework::MenuEntry *entry)
    {
        ...
        while (true)
        {
            ...
            switch (choice)
			{
				case 0: keyboard.Open(future_fly.yaw_strength, future_fly.yaw_strength); break;
				case 1: keyboard.Open(future_fly.pitch_limit, future_fly.pitch_limit); break;
                case 2: keyboard.Open(future_fly.speed_forward, future_fly.speed_forward); break;
                case 3: keyboard.Open(future_fly.speed_backward, future_fly.speed_backward); break;
            }
        }
    }
}