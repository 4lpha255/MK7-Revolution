...
namespace base
{
    void entries::ui::enhanced_minimap_menu(CTRPluginFramework::MenuEntry *entry)
    {
        ...
        while (true)
        {
            ...
            {
                std::format("Extended Minimap Itmes ({})", menu::s_toggles[enhanced_minimap.extended_minimap_items]),
                std::format("Directed Heads ({})", menu::s_toggles[enhanced_minimap.directed_heads]),
